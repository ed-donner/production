...
- Added `update_todo` tool to allows the agent to explicitly mark each research step as complete, failed, or skipped, reducing the chance of repeated or out-of-order work.

- Updated the `context.py` to include a todo template and integrated into `get_agent_instructions()`. 
